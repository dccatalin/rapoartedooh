...
class CustomScheduleDialog(QDialog):
    def __init__(self, parent=None, start_date=None, end_date=None):
        ...
        self.setWindowTitle("Orar Diferentiat pe Zile")
        self.resize(400, 500)
    ...
    def init_ui(self):
        ...
        # Info label
        info = QLabel("Definiti orarul pentru fiecare zi a campaniei.\nFormat: HH:MM-HH:MM (ex: 09:00-17:00)")
        ...
        while current_date <= self.end_date:
            ...
            day_input = QLineEdit()
            day_input.setText("09:00-17:00")
            day_input.setPlaceholderText("HH:MM-HH:MM")
            
            scroll_layout.addRow(day_label, day_input)
            self.schedule_inputs[current_date] = day_input
    ...
    def get_schedule(self):
        """Return dictionary of date -> hours string"""
        schedule = {}
        for date, input_widget in self.schedule_inputs.items():
            schedule[date] = input_widget.text()
        return schedule
